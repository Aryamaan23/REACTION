...
class JsonForm extends Component{
    constructor(props){
        super(props);
        this.state={Gender:"Male",Married:"No",Dependents:0,
        Education:"Graduate",Self_Employed:"No",
        ApplicantIncome:5489,CoapplicantIncome:0,LoanAmount:128,Loan_Amount_Term:360,Credit_History:1,
        Property_Area:"Urban",score:1
    };
    ...
    handleSubmit(event){
        ...
        const bodyData=JSON.stringify({
            ...
            "ApplicantIncome":this.state.ApplicantIncome,"CoapplicantIncome":this.state.CoapplicantIncome,"LoanAmount":this.state.LoanAmount,"Loan_Amount_Term":this.state.Loan_Amount_Term,"Credit_History":this.state.Credit_History,
        ...
        return(
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" value={this.state.Self_Employed} name="Self_Employed" onChange={this.handleChange}></input></td></tr>
